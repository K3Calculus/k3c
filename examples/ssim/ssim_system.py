...
"""
SSIM transition function — plain module-level function for SSIM file parsing.
...
def _get_validate_event():
    """Lazy import to avoid circular dependency with ssim_spec."""
...
def ssim_transition(
    ...
    field_errors = _get_validate_event()(event)
    if field_errors:
